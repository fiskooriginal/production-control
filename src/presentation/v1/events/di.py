...
async def get_event_type_query_service(session: async_session) -> EventTypeQueryService:
...
async def get_list_events_query_handler(query_service: event_type_query_service) -> ListEventsQueryHandler:
